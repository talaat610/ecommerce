...
<Swiper
    ...
    <div className='col-span-8 pt-10 space-y-5'>
        ...
        <h3 className='text-xl font-semibold text-primary'>  {data?.data.data.category.name}</h3>
        </div>
    ...
    <div className=' w-[150px] flex justify-between items-center'>
                 <h4 className='bg-primary rounded-md p-0.5 text-white'>Reviews :{data?.data.data.ratingsQuantity}
                 </h4>
                 ...
                 <div className='flex gap-1'>
                     ...
                     </svg><h4>{data?.data.data.ratingsAverage}</h4>
                 </div>
    </div>
    ...
    <button className='text-white bg-primary rounded-md  px-3 w-full py-1 hover:bg-darkPrimary'>Pay Now</button>
    <button className=' bg-gray-300 rounded-md  px-3 w-full py-1 hover:bg-gray-400 hover:text-white'>Add To Cart</button>
         </div>
...
<div className='w-full h-1 my-12 bg-primary'></div>
<h3 className='text-4xl font-extrabold'>Related product</h3>

<div className='w-1/4 h-1 my-12 bg-primary'></div>

<div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 my-10'>

{related?.map( (item)=>(
    <Card.product.item={item} key={item._id}/>
) )}
</div>
